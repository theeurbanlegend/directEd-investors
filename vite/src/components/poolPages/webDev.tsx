...
const WEBDEV: React.FC = () => {
    ...
    const scrollToStudents = () => {
        // Find the student profiles section
        const studentSection = document.getElementById('studentProfiles');
        if (studentSection) {
            // Scroll to the student profiles section
            window.scrollTo({
                top: studentSection.offsetTop,
                behavior: 'smooth'
            });
        }
    };
            ...
            <div className="flex justify-center items-center h-full ">
                <div className="flex flex-col md:flex-row items-center w-full p-4">
                    <div className="md:w-1/3 text-center md:text-left p-4">
                        ...
                        <h1 className="text-3xl text-center font-bold text-gray-800 mb-4">Website Development</h1>
                    </div>
