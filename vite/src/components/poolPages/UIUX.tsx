     ...
     <div className="flex justify-center mt-8">
            ...
            <div className="mx-auto p-4">
                <section className="my-8 text-center max-w-4xl mx-auto">
                    ...
                    <p className="text-lg mb-4">
                        UI designers focus on the visual elements of the interface, such as layout, typography, and color schemes. UX designers, on the other hand, focus on the overall user experience, including usability, accessibility, and interaction design.
                    </p>
                </section>
                <section className="my-8 text-center max-w-4xl mx-auto">
